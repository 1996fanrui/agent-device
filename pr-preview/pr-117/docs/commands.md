...
See [Replay & E2E (Experimental)](/agent-device/pr-preview/pr-117/docs/replay-e2e.md) for recording and CI workflow details.
...
See [Batching](/agent-device/pr-preview/pr-117/docs/batching.md) for payload format, response shape, and usage guidelines.
